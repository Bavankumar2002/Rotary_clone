...
<div class="card shadow-sm">
    <div class="card-body">
        <form action="<?= URLROOT ?>/adminevents/edit/<?= $data['id']; ?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <?php if(!empty($data['image_url'])) : ?>
                    <div class="mt-3">
                        ...
                        <img src="<?= $data['image_url']; ?>" alt="Current Event Image" style="width: 150px; height: 100px; object-fit: cover; border-radius: 4px;">
                    </div>
                <?php endif; ?>
            </div>
